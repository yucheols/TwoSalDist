...
saveRDS(o.models, 'tuning_experiments/output_model_rds/O_koreanus_full_model_CHELSA_fixed_param.rds')
...
# save output as .rds for later use == fixed params
saveRDS(k.models, 'tuning_experiments/output_model_rds/K_koreana_full_model_CHELSA_fixed_param.rds')
...
# save
#ggsave('plots/CHELSA tuning/O.koreanus_CHELSA_cont.png', width = 30, height = 22, dpi = 800, units = 'cm')
...
# save
#ggsave('plots/CHELSA tuning/O.koreanus_CHELSA_bin.png', width = 30, height = 22, dpi = 800, units = 'cm')
...
# save
#ggsave('plots/CHELSA tuning/K.koreana_CHELSA_cont.png', width = 30, height = 22, dpi = 800, units = 'cm')
...
#write.csv(o.models$contrib[[2]], 'tuning_experiments/varimp/CHELSA/O.koreanus_CHELSA_var.imp.csv')
#write.csv(k.models$contrib[[2]], 'tuning_experiments/varimp/CHELSA/K.koreana_CHELSA_var_imp.csv')
...
write.csv(o.models$metrics, 'tuning_experiments/metrics/O.koreanus_full_model_CHELSA_fixed_param.csv')
write.csv(k.models$metrics, 'tuning_experiments/metrics/K.koreana_full_model_CHELSA_fixed_param.csv')

# variable importance
print(o.models$contrib)
print(k.models$contrib)

write.csv(o.models$contrib, 'tuning_experiments/varimp/CHELSA/O.koreanus_full_model_CHELSA_fixed_param_var.imp.csv')
write.csv(k.models$contrib, 'tuning_experiments/varimp/CHELSA/K.koreana_full_model_CHELSA_fixed_param_var_imp.csv')


### export prediction layers 
writeRaster(o.models$preds, 'tuning_experiments/preds/O.koreanus/CHELSA/cont/O.koreanus_full_model_fixed_parm.tif', overwrite = T)  # O. koreanus cont
writeRaster(o.bin, 'tuning_experiments/preds/O.koreanus/CHELSA/bin/O.koreanus_full_model_fixed_parm.tif', overwrite = T)            # O. koreanus bin

writeRaster(k.models$preds, 'tuning_experiments/preds/K.koreana/CHELSA/cont/K.koreana_full_model_fixed_parm.tif', overwrite = T)    # K. koreana cont
writeRaster(k.bin, 'tuning_experiments/preds/K.koreana/CHELSA/bin/K.koreana_full_model_fixed_parm.tif', overwrite = T)              # K. koreana bin
